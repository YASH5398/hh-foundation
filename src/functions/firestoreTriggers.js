...
onCreate(async (snap, context) => {
  try {
    ...
    console.log(String('New message created:') + " " + String(messageData));
    ...
    console.log(String('Successfully sent message notification:') + " " + String(response));
    ...
    console.error(String('Error sending message notification:') + " " + String(error));
    return null;
  }
});
...
onUpdate(async (change, context) => {
  try {
    ...
    if (beforeData.typing !== afterData.typing) {
      console.log(String('Typing status changed in chat:') + " " + String(chatId));
    ...
    console.error(String('Error handling chat update:') + " " + String(error));
    return null;
  }
});
...
onRun(async (context) => {
  try {
    ...
    console.error(String('Error in cleanup function:') + " " + String(error));
    return null;
  }
});