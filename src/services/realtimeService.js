...
class RealtimeService {
  ...
  subscribeToTickets(callback, filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String('Error in tickets subscription:') + " " + String(error));
      ...
      console.error(String('Error setting up tickets subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToPayments(callback, type = 'sendHelp', filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String(`Error in ${type} payments subscription:`) + " " + String(error));
        this.handleSubscriptionError(error, listenerId);
      ...
      console.error(String(`Error setting up ${type} payments subscription:`) + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToUsers(callback, filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String('Error in users subscription:') + " " + String(error));
        this.handleSubscriptionError(error, listenerId);
      ...
      console.error(String('Error setting up users subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToConversations(callback, filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String('Error in conversations subscription:') + " " + String(error));
        this.handleSubscriptionError(error, listenerId);
      ...
      console.error(String('Error setting up conversations subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToMessages(conversationId, callback, filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String('Error in messages subscription:') + " " + String(error));
        this.handleSubscriptionError(error, listenerId);
      ...
      console.error(String('Error setting up messages subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToKnowledgeBase(callback, filters = {}) {
    ...
    try {
      ...
      (error) => {
        console.error(String('Error in knowledge base subscription:') + " " + String(error));
        this.handleSubscriptionError(error, listenerId);
      ...
      console.error(String('Error setting up knowledge base subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  subscribeToAnalytics(callback, filters = {}) {
    ...
    try {
      ...
      collections.forEach((collectionName) => {
        ...
        (error) => {
          console.error(String(`Error in ${collectionName} analytics subscription:`) + " " + String(error));
          this.handleSubscriptionError(error, listenerId);
        }
        );
      ...
      console.error(String('Error setting up analytics subscription:') + " " + String(error));
      throw error;
    }
  }
  ...
  handleSubscriptionError(error, listenerId) {
    console.error(String(`Subscription error for ${listenerId}:`) + " " + String(error));
  ...
  reconnectListener(listenerId) {
    ...
    try {
      ...
      console.error(String(`Failed to reconnect listener ${listenerId}:`) + " " + String(error));
    }
  }
