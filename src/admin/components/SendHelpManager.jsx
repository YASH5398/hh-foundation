...
const SendHelpManager = () => {
    ...
    const setup = async () => {
      ...
      unsub = onSnapshot(
        ...
        (error) => {
          ...
          console.error(String('Firestore onSnapshot permission error:') + " " + String(error));
        }
      );
    };
  ...
  const handleStatusUpdate = async (helpId, newStatus) => {
    try {
      ...
      console.error(String('Error updating status:') + " " + String(error));
    }
  };
  ...
  const handleMarkConfirmed = async (helpId) => {
    try {
      ...
      console.error(String('Error marking as confirmed:') + " " + String(error));
    }
  };
