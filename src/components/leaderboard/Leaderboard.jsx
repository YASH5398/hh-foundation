  ...
  useEffect(() => {
    ...
    async function fetchLeaderboard() {
      ...
      try {
        ...
        // Filter to only activated users for leaderboard
        const activatedUsers = allUsers.filter((user) => user.isActivated === true);

        // Sort by totalEarnings (descending) and take top 100
        const data = activatedUsers.
        sort((a, b) => (b.totalEarnings || 0) - (a.totalEarnings || 0)).
        slice(0, 100);

        console.log(String("Leaderboard fetched users:") + " " + String(data.length));
        ...
        console.error(String("Leaderboard fetch error:") + " " + String(e));
