...
import {
  ...
  FiToggleLeft, FiToggleRight, FiCheck, FiAlertTriangle } from
'react-icons/fi';
...
const NotificationPreferences = ({ isOpen, onClose, userId }) => {
  ...
  const loadPreferences = async () => {
    try {
      ...
      console.error(String('Error loading preferences:') + " " + String(error));
    } finally {
      setLoading(false);
    }
  };
  ...
  const savePreferences = async () => {
    ...
    try {
      ...
      console.error(String('Error saving preferences:') + " " + String(error));
      // Show error message
    } finally {
      setSaving(false);
    }
